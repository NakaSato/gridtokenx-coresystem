...
cmd_status() {
    ...
    local services=(
        ...
        "Simulator API:process:gridtokenx-smartmeter-simulator/backend"
        "Trading UI:process:gridtokenx-trading/"
        "Explorer UI:process:gridtokenx-explorer/"
        "App Portal:process:gridtokenx-portal"
        "Simulator UI:process:gridtokenx-smartmeter-simulator/frontend"
    )
