...
- Default: solana-test-validator for integration tests.
- Use Surfpool when you need realistic cluster state (mainnet/devnet cloning, time travel, complex CPIs) locally.
...
- Integration test: solana-test-validator (default); Surfpool for realistic mainnet/devnet state.
