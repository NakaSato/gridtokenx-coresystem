...
description: A testing pyramid for Solana programs using LiteSVM for fast unit tests, Mollusk for isolated instruction checks, and solana-test-validator (default) or Surfpool for integration tests.
---
...
2. **Integration tests (default)**: solana-test-validator. Use Surfpool when you need realistic mainnet/devnet state (cloning, time travel, complex CPIs).
