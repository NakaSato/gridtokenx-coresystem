...
โครงสร้าง escrow ที่อธิบายข้างต้น คือหนึ่งบัญชี escrow PDA ต่อหนึ่งฝ่ายและผูกที่อยู่บัญชีเข้ากับ payload ที่ลงนาม เป็นแบบจำลองที่หัวข้อนี้วิเคราะห์และเป็นแบบที่คำสั่ง `settle_offchain_match` กับ `batch_settle_offchain_match` ใช้งาน ทั้งนี้โปรแกรมยังมีจุดเข้าการชำระอีกทางหนึ่งแบบ custodial (`execute_atomic_settlement`) ซึ่งบัญชี escrow เป็นบัญชีโทเคนแบบรวมกองที่เป็นของกุญแจแพลตฟอร์มแทนที่จะเป็นของคู่สัญญา และเป็นเส้นทางที่ต้นแบบซึ่งติดตั้งใช้งานเรียกอยู่ในปัจจุบัน (ดู@sec:trading-program) สมบัติคงที่ (invariant) ทุกข้อที่กล่าวต่อจากนี้เป็นของเส้นทาง non-custodial ส่วนบนเส้นทาง custodial นั้น สมบัติที่ได้มาจากการ*ผูกที่อยู่บัญชี* กล่าวคือผู้โจมตีไม่อาจสลับบัญชี escrow ของเหยื่อเข้ามา และอำนาจจ่ายเงินออกเป็นสมบัติของเส้นทางโค้ดมิใช่ของกุญแจที่ผู้ดูแลถือไว้ ย่อมถูกแทนที่ด้วยความเชื่อถือในกุญแจแพลตฟอร์ม ขณะที่สมบัติที่บังคับจาก *payload* ได้แก่ ลายเซ็นทั้งสองฝ่าย order nullifier การครอสราคา เพดานการไหล และการแบ่งมูลค่าด้วยเลขคณิตแบบตรวจสอบ ยังคงเป็นจริงเช่นเดิม
