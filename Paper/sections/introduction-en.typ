...
_Rooftop-solar prosumers produce surplus they want to trade, yet direct P2P stays blocked by grid constraints and the absence of transparent price discovery — this paper contributes an architectural design and simulation evaluation of a governable, cost-predictable P2P market._
  ...
  kind: table,
  {
    ...
    table(
      ...
      ..sorted
        .map(e => (
          strong(e.short),
          [#e.long],  // English build: e.long is already English; skip the Thai gloss (e.description)
        ))
        .flatten()
    )
  },
