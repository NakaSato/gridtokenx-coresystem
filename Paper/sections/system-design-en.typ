...
#figure(
  ...
  text(size: 8pt)[
    ...
    #table(
      ...
      [`GovernanceConfig`], [`[poa_config]`], [singleton: authority, pending_authority, REC policy, maintenance flag, min_quorum_votes, and counters],
