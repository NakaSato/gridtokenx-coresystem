...
#figure(
  ...
  caption: [ลำดับเวลาการเคลียร์ตลาดของโปรแกรม oracle: ค่าอ่านที่ลงนามแล้วทยอยเข้ามาตลอดหน้าต่างรวมข้อมูล 15 นาที (900 วินาที) เมื่อหน้าต่างปิด oracle จะรวมค่าอ่าน สั่งเคลียร์ตลาด แล้วชำระคู่ที่จับคู่ได้บนเชน ทั้งนี้เป็นเส้นทาง telemetry บนเชนตามที่ออกแบบและที่วัดแบบแยกส่วนใน@sec:meter-scale ส่วนสายงานที่ติดตั้งใช้งานจริง*ไม่ได้*เขียนค่าอ่านลงเชน แต่จบเส้นทาง ingest ไว้ที่ Redis Streams และถังหน้าต่างเวลาใน@fig:telemetry-dissemination แล้วจึงแตะเชนเฉพาะตอน mint และตอนชำระธุรกรรมเท่านั้น],
) <fig:clearing-window>
