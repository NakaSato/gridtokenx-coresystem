...
ในด้านกลไกเชิงเศรษฐศาสตร์ ระบบใช้โทเคนพลังงาน (energy token) ที่ออกจากการผลิตจริงและรับรองด้วย Renewable Energy Certificate (REC; ระบบบนเชนใช้ตัวระบุชื่อ erc) ร่วมกับเหรียญ stablecoin ที่ตรึงค่ากับเงินบาท (THBC) สำหรับการตั้งราคาและชำระธุรกรรม และโทเคน GRX สำหรับการ stake และการกำกับดูแล (governance) โดยรายละเอียดแบบจำลองราคาอธิบายไว้ใน@sec:pricing-market-mechanism และรายละเอียดของโปรแกรมที่เกี่ยวข้องอธิบายไว้ใน@sec:smart-contract-programs
