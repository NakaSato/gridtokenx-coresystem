...
- **Design + simulation. No fiat is held and no fiat rail exists.** `issue_thbc`,
  ...
  the payment leg; compose defaults to `simulated`. Of nine invariants F3, F5, F7, F8
  and F9 may be described as guarantees — `GET /v1/admin/invariants` is authoritative, and
