...
export ORACLE_BRIDGE_REST="${ORACLE_BRIDGE_REST:-http://localhost:4030}"
export ORACLE_BRIDGE_GRPC="${ORACLE_BRIDGE_GRPC:-localhost:5030}"  # NOTE: telemetry test uses 5030
