...
| TD-002 | Settlement settles a freshly-completed bin before late readings arrive → strands energy | aggregator | 🟠 | before onboarding intermittent/offline-buffered meters | open |
